    ...
    function criarBotao (){
        ...
        btnTexto.innerHTML = "Pensou que a PF não iria descobrir seus esquemas de sonegação de imposto? Voce precisa fugir para outra cidade, trocar de nome (quem sabe fazer uma cirurgia?), sorte sua que alguns dos seus investimentos com os laranjas permitiram voce a ter parte dos seus 'rendimentos' de volta.";
        btn.innerHTML = `Clique aqui para pagar propina de no mínimo ${precoReset} reais para fugir da PF.`
